    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h2>Visi Misi</h2>
                <p>
                    Sekolah yang berbasis Pondok Pesantren dimana tidak hanya mengutamakan pendidikan umum namun juga Pendidikan Moral yang agamis guna membentuk kepribadian atau karakter peserta didik yang bertanggung jawab, disiplin serta menghargai lingkungan kehidupan sosialnya, membentuk insan-insan yang madani, dan berahlakul karimah. 
Membiasakan peserta didik untuk disiplin dan menghargai waktu, dengan bangun awal setiap hari mulai jam 3.00 pagi untuk melaksanakan Tahajud, Tadarus Alqur’an, Sholat selalu dibiasakan dilakukan secara berjama’ah di mesjid. 
                ...
                <div class="col-md-5">
                    <img src="<?php echo base_url().'theme/images/3.jpeg'?>" class="img-fluid" alt="#">
                </div>
            </div>
        </div>
    </section>
