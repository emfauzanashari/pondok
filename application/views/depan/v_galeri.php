...
<div class="row">
  <div class="col-md-12">
    <h3 class="gallery-style">ALbum Gallery Photo</h3>
  </div>
</div><br>
<div class="row">
 <!--  <div class="col-md-12">
 ...
 <div class="col-md-12">
<div id="accordion">
  <?php $i = 1;foreach ($alb->result() as $row) : ?>
  ...
  <div class="card">
    ...
    <div id="collapse<?= $i;?>" class="collapse" data-parent="#accordion">
      <div class="card-body">
        <div class="row">
         <?php foreach ($all_galeri->result() as $rows) : ?>
          <?php if($row->album_id == $rows->galeri_album_id){ ?>
            <div class="col-sm-4">
          <a href="<?php echo base_url().'assets/images/'.$rows->galeri_gambar;?>" class="image-link2">
             <img src="<?php echo base_url().'assets/images/'.$rows->galeri_gambar;?>" class="all img-fluid" alt="#" />
            </a>
          </div>
          <?php }?>
         <?php endforeach;?>
